...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-cyan-500/10 rounded-full blur-3xl animate-float" style={{ animationDelay: '2s' }}></div>
      ...
      <div className="w-full max-w-md relative z-10 animate-slide-up">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold text-gradient mb-2">Join VantFlow</h1>
          <p className="text-gray-400">Start automating with AI in seconds</p>
        </div>
